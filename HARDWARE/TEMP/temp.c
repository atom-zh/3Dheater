...
const double Temp_Tab_100K[]=															//3950-100K阻值表 180
{
    1787.9797,1679.6017,1578.5061,1484.1584,1396.0662,1313.7754,1236.8685,1164.9598,1097.6941,1034.7432,    //-30
    975.8038, 920.5962, 868.8615, 820.3603, 774.871,  732.1889, 692.1238, 654.4999, 619.154,  585.9346,     //-20
    554.7016, 525.3245, 497.6821, 471.6621, 447.1599, 424.0781, 402.3264, 381.8204, 362.4818, 344.2375,     //-10
    327.0195, 310.764,  295.4121, 280.9084, 267.2014, 254.2428, 241.9877, 230.394,  219.4224, 209.0361,     //0
    199.2007, 189.8841, 181.0559, 172.6881, 164.754,  157.229,  150.0898, 143.3144, 136.8825, 130.7749,     //10
    124.9734, 119.4612, 114.2223, 109.2417, 104.5053, 100,      95.7132,  91.6333,  87.7492,  84.0505,      //20
    80.5274,  77.1707,  73.9717,  70.9222,  68.0144,  65.2411,  62.5954,  60.0707,  57.661,   55.3604,      //30
    53.1635, 51.0651, 49.0602, 47.1443, 45.313,  43.5621, 41.8878, 40.2862, 38.7539, 37.2876,               //40
    35.8842, 34.5405, 33.2538, 32.0214, 30.8408, 29.7096, 28.6253, 27.586,  26.5895, 25.6338,               //50
    24.7171, 23.8376, 22.9937, 22.1836, 21.4061, 20.6594, 19.9424, 19.2537, 18.592,  17.9562,               //60
    17.3452, 16.7578, 16.193,  15.6499, 15.1276, 14.6251, 14.1417, 13.6764, 13.2286, 12.7976,               //70
    12.3825, 11.9828, 11.5978, 11.227,  10.8697, 10.5254, 10.1935, 9.8736,  9.5652 , 9.2678,                //80
    8.9809, 8.7042, 8.4373, 8.1797, 7.9312, 7.6912, 7.4596, 7.236,  7.0201, 6.8115,                         //90
    6.6101, 6.4155, 6.2274, 6.0457, 5.8701, 5.7003, 5.5362, 5.3775, 5.224,  5.0755,                         //100
    4.9319, 4.793,  4.6586, 4.5285, 4.4026, 4.2807, 4.1627, 4.0484, 3.9378, 3.8306,                         //110
    3.7268, 3.6263, 3.5289, 3.4345, 3.343,  3.2543, 3.1683, 3.085,  3.0042, 2.9258,                         //120
    2.8498, 2.7761, 2.7045, 2.6352, 2.5678, 2.5025, 2.4391, 2.3775, 2.3178, 2.2598,                         //130
    2.2034, 2.1487, 2.0956, 2.044,  1.9939, 1.9452, 1.8978, 1.8518, 1.8071, 1.7637,                         //140 ~ 149
};
...
static float Read_ADC_Data_100K(void)			//读取ADC值
{
	...
	Resistance = (RES_100K*Voltage/(Power_Vol-Voltage));		//RES_100K单位kΩ；温度传感器串联分压电阻，可根据实际电路修改
	DEBUG("Resistance_100K: %lf\n", Resistance);
	Binaty = Binary_Search(Resistance,Temp_Tab_100K,Length_100K);			//140是Temp_Tab_100K数组的长度
	DEBUG("Binary_Search_100K: %d\n",Binaty);
	Temp_100K = Binaty - 30;										//数组起始是-30度，这里需要减30；
	printf("NTC_100K TEMP = %0.1f .\n", Temp_100K);
	return Temp_100K;
}
